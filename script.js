...
async function data() {
    ...
    document.getElementById("summoner_ranked_data").innerHTML = `Tier: ${tier1}, Rank: ${rank1}, Wins: ${wins1}, Losses: ${losses1}, Queue Type: ${queueType1}, LP: ${leaguePoints1}`;
    
    const { tier: tier2, rank: rank2, wins: wins2, losses: losses2, queueType: queueType2, leaguePoints: leaguePoints2 } = rankedData[1];
    document.getElementById("summoner_ranked_data").innerHTML += `<br>Tier: ${tier2}, Rank: ${rank2}, Wins: ${wins2}, Losses: ${losses2}, Queue Type: ${queueType2}, LP: ${leaguePoints2}`;

    // Set rank image
    var rankImageElement = document.getElementById("rank_image");
    var rankImagePath = "rankimages/" + tier.toLowerCase() + ".png"; // assuming the image file names are the lowercased tier names
